...
Read `/home/zezok/Security/Bounty/ClaudeBountySystem/orchestrator.md` and follow it. It is the
...
2. **Run with `cwd = /home/zezok/Security/Bounty/ClaudeBountySystem`** so the enforcement hooks
   load and `runs/` paths resolve.

If the user named a target, use it. If not, list the programs under
`/home/zezok/Security/Bounty/ClaudeBountySystem/` and ask which — do not pick one.
